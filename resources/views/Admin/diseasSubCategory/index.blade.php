@extends('Layouts.layout', ['activePage' => 'diseasSubCategory', 'titlePage' => "diseas Subcategory"])
...
<div class="content">
    <div class="row">
        <div class="col-sm-4 col-3">
            <h4 class="page-title">Diseas SubCategory</h4>
        </div>
        <div class="col-sm-8 col-9 text-right m-b-20">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addcat">Add Diseas SubCategory</button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table table-border table-striped custom-table  mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#a{{$category->id}}">Edit</button></td>
                            <td>
                                <form method="POST" action="diseasSubCategory/{{ $category->id  }}">
                                    @csrf
...
<div class="modal fade" tabindex="-1" id="addcat" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="diseasSubCategory" id="editForm">
                    @csrf
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Drug Category</label>
