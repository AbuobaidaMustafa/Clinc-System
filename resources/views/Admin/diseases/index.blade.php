@extends('Layouts.layout', ['activePage' => 'diseases', 'titlePage' => "Diseases"])
...
@section('content')
            ...
            <div class="content">
                <div class="row">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addcat">Add Diseases</button>
                    </div>
                </div>
<div class="row">
					<div class="col-md-12">
